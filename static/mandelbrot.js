...
function mandelbrot(xmin, xmax, ymin, ymax, width, height, result, iterations) {
...
onmessage = (evt) => {
    ...
    switch (data.type) {
        case "mandelbrot":
            let result = new Uint8Array(mandelbrot(data.xmin, data.xmax, data.ymin, data.ymax, data.width, data.height, data.buffer, data.iterations));
